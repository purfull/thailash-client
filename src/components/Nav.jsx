...
const NavBar = () => {
    ...
    return (
        <header className="fixed top-0 w-full z-50">
            <nav className="px-4 h-[8vh] md:h-[14vh] flex items-center w-full border-b border-[#046E3D40] bg-[#E9FFF3] ">
            ...
            <div className="marquee-container shadow-md pb-1 border-b border-[#046E3D40]">
                <div className="marquee-content text-sm md:text-base font-semibold tracking-wide">
                    Free delivery for all orders &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Free delivery for all orders &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Free delivery for all orders &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Free delivery for all orders &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Free delivery for all orders &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Free delivery for all orders &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Free delivery for all orders &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Free delivery for all orders &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
            </div>
        </header>
    );
