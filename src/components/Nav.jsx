...
const NavBar = () => {
  ...
  const DrawerList = (
    ...
    >
      ...
      <div
        className="md:hidden text-[#056E3D] relative z-50"
        onClick={toggleMenu}
        style={{
          display: "flex",
          justifyContent: "end",
      ...
      <a
        ...
        className={`py-2 my-1 px-6 border-b md:border-none ${
          activeSection == "home"
            ? "bg-[#056E3D] text-white"
            : "bg-[#FFFFFF87] text-[#056E3D]"
  ...
  return (
    <nav className="px-4 h-[8vh] md:h-[14vh] flex items-center w-full fixed top-0 z-50 border-b border-[#046E3D40] bg-[#E9FFF3] ">
      <div
        className="container mx-auto flex flex-row bg-red-200 
        justify-between items-center text-[#056E3D]"
      >
        {/* Logo */}
        <div className="text-[#056E3D] text-xl font-bold w-[22vw] md:w-[8vw]">
        ...
        <ul
          ...
          className="fixed bg-blue-900
          top-0 right-0 w-2/3 z-40 transform rounded-[25px] border border-[#046E3D40] md:static md:flex md:flex-row md:items-center md:space-x-6 md:translate-x-0 md:w-auto px-4 font-bold hidden sm:flex"
        >
          <li>
            <a
              // href={activeSection === 'home' ? "#home" : '/'}
              onClick={() => handleNavigation("home")}
              className={`py-2 my-1 rounded-[25px] px-6 border-b md:border-none ${
                activeSection == "home"
                  ? "bg-[#056E3D] text-white"
                  : "bg-[#FFFFFF87] text-[#056E3D]"
              } cursor-pointer`}
        ...
        <div className="justify-between items-center font-bold hidden md:flex">
          <a
            href="/checkout"
            className="mr-4 px-5 py-2 rounded-[25px] border-2 border-[#056E3D] cursor-pointer"
          >
            Shop Now
          </a>
          <a
            href="/checkout"
            className="p-3 rounded-full border-2 border-[#056E3D] cursor-pointer"
          >
