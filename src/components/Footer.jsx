const Footer = (width) => {
    return (
        <div id="contact" className={`h-auto bg-gradient-to-r from-green-700 to-green-900 text-white py-12 px-6 md:px-20 w-[${width}]`}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                {/* Address, Phone, Email Section */}
                <div>
                    <h3 className="text-xl font-bold mb-6 pb-2">Contact Us</h3>
                    <p className="mb-3">3/127, Plot No 144, Sirangudi Puliyur, Naapattinam - 611104</p>
